...
n=-0.002578211534468;              %2015
fert_26=0.9375;                    %2015 ENDOG.FERTILITY.m
e=1.009368277002316;               %2015 e=1/z with z=1
b=1.172880806665463;               %2015 government debt as % of gdp
D=0.23366031254802;                %2015
theta=4.899175668147334;           %2015
AL_growth= 0.006460448230438;
AL=2.99049071248668;               %2015
AK=1;                              %2015
...
a57 = (rk+e*(1-delta))*a56/sv56 - (fert_26*x56) - c56;
...
disp([num2str(0) '     ' num2str(oo_.steady_state(278,1)*1/(1+n)^(151)) '       ' num2str(oo_.steady_state(276,1)*1/(1+n)^(151)) '     ' num2str(oo_.steady_state(275,1)*1/(1+n)^(151))])

disp(['   '])
disp (['Income (Y)  ' 'Consumption (C)  ' 'Agg. Profit (PI)' 'Investment (I)'])
disp([num2str(oo_.steady_state(274,1)*1/(1+n)^(151)) '     ' num2str(oo_.steady_state(277,1)*1/(1+n)^(151)) '          ' num2str(oo_.steady_state(273,1)) '    ' num2str(oo_.steady_state(282,1)*1/(1+n)^(151))])
